...
for file in allfile:
    ...
    while True:
        ...
        if hypervolumeArray != []:
            ...
            metric = HV(ref_point=np.array([250, 1.5, 2]))
    ...
    # print(f.name)
    file = open("C:/Users/ADMIN/Downloads/Multi/Multi/exp2/result_"+map+".txt", 'a+')
...
for i, d in enumerate(df):
    ...
    plt.scatter(x, y)
plt.title(map)
plt.savefig("C:/Users/ADMIN/Downloads/Multi/Multi/exp2/"+map+".pdf", format="pdf", bbox_inches="tight")
